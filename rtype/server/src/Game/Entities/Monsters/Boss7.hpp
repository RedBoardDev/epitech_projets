#ifndef BOSS7MONSTER_HPP
#define BOSS7MONSTER_HPP

#include "../Entity.hpp"
#include "Monster.hpp"

class Boss7Monster: public Monster {
    public:
        /**
         ...
         */
        Boss7Monster(Room &room, u_int id, short x, short y);
        /**
         * @brief Construct a new Little Monster object
         *
         * @param room The room where the entity is
         ...
         */
        Boss7Monster(Room &room, u_int id, const std::pair<short, short> &pos);
        virtual ~Boss7Monster() = default;
